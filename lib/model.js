...
var App = Model.extend({
  ...
  derived: {
    ...
    nupkg_version: {
      deps: ['appversion', 'version'],
      fn: function() {
        if (!this.appversion) return this.version;
        return this.appversion;
      }
    },
    nupkg_filename: {
      deps: ['name', 'nupkg_version'],
      fn: function() {
        return format('%s.%s.nupkg', this.nuget_id, this.nupkg_version);
      }
    }
  },
  parse: function(resp) {
